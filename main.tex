...
% Shared height for figures that sit side by side in a row
\newcommand{\figrowheight}{7.8cm}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Anomaly Detection in the ATLAS Trigger}
    ...
    \vspace{0.4cm}
    \textbf{The first ATLAS anomaly trigger has collected data, with Run 4 studies ongoing!}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Edge ML \& Smart Detectors}
    ...
    \begin{figure}
      ...
      \includegraphics[height=\figrowheight]{figures/openhouse/drift_cell_ml.png}%
      \hspace{1.5cm}%
      \includegraphics[height=\figrowheight]{figures/wf_BSO.png}
    \end{figure}
    ...
    and \textbf{dual-readout calorimeters}, and beyond particle physics in
  ...
  \begin{block}{Quantum Machine Learning}
    ...
    \begin{figure}
      \centering
      % \hspace{1.5cm}%
      \includegraphics[height=\figrowheight]{figures/openhouse/arch_qae_pqc.png}
    \end{figure}
    ...
    \input{figures/fig_smpo}
    \vspace{-1.5cm}
    Tensor networks can be run in tens of nanoseconds on FPGAs and exploit the \textbf{short- and long-range entanglement structure} of the underlying physics to yield excellent signal-to-background separation.
  \end{block}
