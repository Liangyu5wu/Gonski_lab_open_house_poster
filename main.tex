...
\begin{column}{\colwidth}
  ...
  \begin{block}{Edge ML \& Smart Detectors}
    ...
    \begin{column}{0.60\columnwidth}
      ...
      future experiments such as \textbf{FCC-ee} --- including \textbf{drift
      chambers} and \textbf{dual-readout calorimeters} --- as well as beyond
      particle physics, in \textbf{photon science} and \textbf{quantum information
      science}.
    \end{column}
