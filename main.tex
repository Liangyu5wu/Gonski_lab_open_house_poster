...
\begin{column}{\colwidth}
  ...
  \begin{block}{Large-Scale ML for Particle Physics}
    ...
    \begin{column}{0.52\columnwidth}
      % Logo heads the subsection; it also brings the left column up to roughly the
      % height of the accuracy plot on the right.
      \centerline{\includegraphics[width=0.48\columnwidth]{figures/openhouse/NEXUS_logo.pdf}}
